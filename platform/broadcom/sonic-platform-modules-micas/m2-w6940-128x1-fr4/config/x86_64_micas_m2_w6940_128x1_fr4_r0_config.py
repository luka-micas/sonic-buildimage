    ...
    "others": [
        ...
        },
        {
            ...
            "device": [
                ...
                {"id": "xdpe12284_5", "name": "wb_xdpe12284", "bus": 70, "loc": 0x68, "attr": "hwmon"},
                {"id": "xdpe12284_6", "name": "wb_xdpe12284", "bus": 71, "loc": 0x68, "attr": "hwmon"},
            ],
        },
        {
            "name": "xdpe132g5c",
            "device": [
                ...
                {"id": "xdpe132g5c_4", "name": "wb_xdpe132g5c_pmbus", "bus": 69, "loc": 0x40, "attr": "hwmon"},
            ],
        },
        {
            "name": "ucd90160",
...
PMON_SYSLOG_STATUS = {
    ...
    "psus": {
        ...
        "status": [
            ...
            {"path": "/sys/s3ip/psu/%s/alarm", "okval": 0},
        ],
        "nochangedmsgflag": 1,
        "nochangedmsgtime": 60,
        "noprintfirsttimeflag": 0,
...
DEVICE = [
    ...
    {"name": "wb_xdpe132g5c", "bus": 69, "loc": 0x10},
]
    ...
    "slot0": {
        ...
        "TEST": {
            "fpga": [
                ...
                {"chain": 2, "file": "/etc/.upgrade_test/0x40bd/dom_fpga_test_header.bin", "display_name": "DOM_FPGA"},
            ],
            "cpld": [
                {"chain": 3, "file": "/etc/.upgrade_test/0x40bd/scm_cpld_spi_test_header.bin", "display_name": "SCM_CPLD_SPI"},
                {"chain": 4, "file": "/etc/.upgrade_test/0x40bd/mcb_cpld_spi_test_header.bin", "display_name": "MCB_CPLD_SPI"},
                {"chain": 5, "file": "/etc/.upgrade_test/0x40bd/smb_cpld_spi_test_header.bin", "display_name": "SMB_CPLD_SPI"},
                {"chain": 6, "file": "/etc/.upgrade_test/0x40bd/fcb_b_cpld_spi_test_header.bin", "display_name": "FCB_B_CPLD_SPI"},
                {"chain": 7, "file": "/etc/.upgrade_test/0x40bd/fcb_t_cpld_spi_test_header.bin", "display_name": "FCB_T_CPLD_SPI"},
                #{"chain": 8, "file": "/etc/.upgrade_test/0x40bd/mac_pcie_spi_test_header.bin", "display_name": "MAC_PCIe"},
            ],
        },
    },
